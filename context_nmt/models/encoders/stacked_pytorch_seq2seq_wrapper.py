...
class StackedPytorchSeq2SeqWrapper(Seq2SeqEncoder):
    """
    ...
    def forward(
        ...
        logger.info(f"The shape of final_states is {final_states[0].shape}")
        ...
        logger.info(
            f"The shape of unpacked_sequence_tensor is {unpacked_sequence_tensor.shape}"
        )
        assert 1 != 1
