python gokart_runner.py --local-scheduler --module context_nmt context_nmt.GenerateContextIndicator \
    ...
    --source-lang ja --target-lang en --context-aware-sentencepiece-model "/data/10/litong/NICT-MT/all-4-sentencepiece-en_ja-32000.model" \
    --context-aware-translation-models '{"-1": "/data/temp/litong/context_nmt/fairseq/data-bin/jiji_onto_ami_conver_train_1-to-1_ja_en/checkpoint_best.pt", "1": "/data/temp/litong/context_nmt/fairseq/data-bin/jiji_onto_ami_conver_train_2-to-1_ja_en_context_bias_1/checkpoint_best.pt", "2": "/data/temp/litong/context_nmt/fairseq/data-bin/jiji_onto_ami_conver_train_2-to-1_ja_en_context_bias_2/checkpoint_best.pt", "3": "/data/temp/litong/context_nmt/fairseq/data-bin/jiji_onto_ami_conver_train_2-to-1_ja_en_context_bias_3/checkpoint_best.pt", "4": "/data/temp/litong/context_nmt/fairseq/data-bin/jiji_onto_ami_conver_train_2-to-1_ja_en_context_bias_4/checkpoint_best.pt", "5": "/data/temp/litong/context_nmt/fairseq/data-bin/jiji_onto_ami_conver_train_2-to-1_ja_en_context_bias_5/checkpoint_best.pt"}'
