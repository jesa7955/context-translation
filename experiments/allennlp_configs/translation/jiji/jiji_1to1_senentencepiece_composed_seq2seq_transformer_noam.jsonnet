...
local train_dataset_reader = create_dataset_reader('1-to-1', 'none', share_tokenizer, share_tokenizer, common_token_indexers, common_token_indexers, true);
...
create_configuration(train_dataset_reader, val_dataset_reader, create_trainer(0), model, 32)
