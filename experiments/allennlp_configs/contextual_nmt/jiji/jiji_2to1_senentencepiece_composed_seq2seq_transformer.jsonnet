local model = import '../common/composed_seq2seq_transformer_factored.libsonnet';
...
local train_dataset_reader = create_dataset_reader('2-to-1', 'none', share_tokenizer, share_tokenizer, common_token_indexers, common_token_indexers, true, true);
local val_dataset_reader = create_dataset_reader('2-to-1', 'none', share_tokenizer, share_tokenizer, common_token_indexers, common_token_indexers, true, true);

create_configuration(train_dataset_reader, val_dataset_reader, create_trainer(0), model, 80)
