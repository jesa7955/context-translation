...
local train_dataset_reader = create_dataset_reader('2-to-1', 'none', {}, en_tokenizer, ja_tokenizer);
local val_dataset_reader = create_dataset_reader('2-to-1', 'none', {}, en_tokenizer, ja_tokenizer);

create_configuration(train_dataset_reader, val_dataset_reader, create_trainer(2), model)
